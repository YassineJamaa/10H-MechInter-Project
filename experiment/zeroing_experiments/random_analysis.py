...
def main():
    ...
    percentages = np.linspace(0.0, 0.025, 26)[::2]
    # percentages = np.array([0.005, 0.01])
    random_predictions = []
    ...
    json_file= os.path.join("Result", "PERCENTAGES_ANALYSIS", f"RANDOM_top1_ANALYSIS", model_name, f"{type(benchmark).__name__}_randoms.json")
    data_dict = {
